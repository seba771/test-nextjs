        ...
        <section className="w-full h-full">
            <section className="h-screen bg-gradient-to-tr from-[#ff8c00] to-[#FFD700] text-primary ">
                <div className="text-center flex flex-col items-center justify-center h-screen">
                    <h1 className="font-semibold text-8xl"> Salviamo le Api</h1>
                    <p className="font-medium text-4xl "> Scopri il mondo delle api, dalla loro importanza al problema che le affligge.</p>
                </div>
            </section>
            <section className="container space-y-28 pt-28">
                <section className="w-full">
                    <div>
                        <p className="text-primary font-semibold border-b-2 text-4xl">L'importanza delle Api</p>
                        <p className="text-secondary text-xl font-light pt-4">Le api sono fondamentali per la salute degli ecosistemi e la nostra sicurezza alimentare. Attraverso l'impollinazione, aiutano la crescita di piante da cui dipendono frutti, verdure e noci. Senza di loro, molte specie vegetali non riuscirebbero a riprodursi, influenzando negativamente l’agricoltura e mettendo a rischio la biodiversità e la sicurezza alimentare globale.</p>
                    </div>
                </section>

                <section className="w-full ">
                    <div>
                        <p className="text-primary font-semibold border-b-2 text-4xl">Cosa fanno</p>
                ...
                <section className="w-full">
                    <div>
                        <p className="text-primary font-semibold border-b-2 text-4xl">Produzione di miele</p>
                ...
                <section className="w-full">
                    <div >
                        <p className="text-primary font-semibold border-b-2 text-4xl">Benefici</p>
                ...
                <section className="w-full">
                    <div>
                        <p className="text-primary font-semibold text-4xl border-b-2">Simili ma diversi</p>
                    </div>
                    <div className="text-secondary text-xl font-light pt-4">
                        <p>
                ...
                <section className="w-full">
                    <div>
                        <p className="text-primary font-semibold text-4xl border-b-2">Testimonianze</p>
                    </div>
                    <div className="text-secondary text-xl font-light pt-4 pb-32">
                        ...
                        <div className="grid grid-cols-2 gap-24 pt-12">
                            <div className="flex flex-col gap-24">
                                <div>
                                    <p className="font-semibold text-primary pb-2">Mario Rosso: Apicoltore</p>
                                    <p>Le api sono fondamentali per il mio lavoro. Da quando la loro popolazione è in declino, ho notato un calo nella produttività dei miei frutti. La mancanza di impollinazione sta davvero minacciando la mia attività. Mi preoccupa che il problema venga ignorato. È urgente intervenire per proteggere questi insetti essenziali per l'ecosistema e l'agricoltura</p>
                                </div>
                                <div>
                                    <p className="font-semibold text-primary pb-2">Silvia Monin: Insegnante scuola elementare</p>
                                    <p>Credo che le api siano un ottimo strumento per sensibilizzare i bambini sui temi ecologici e dell'ambiente. Nelle scuole, parliamo spesso di come le api siano fondamentali per la natura e l'alimentazione. Coinvolgere i più bambini in attività pratiche, come la creazione di piccoli giardini o l'osservazione delle api, aiuta a sviluppare un forte senso di responsabilità e consapevolezza. Le api sono una risorsa educativa che ci insegna la cooperazione e la cura dell'ambiente.</p>
                                </div>
                            </div>
                            <div >
                                <p className="font-semibold text-primary pb-2">Laura Cechi: Ambientalista</p>
                                <p>Ogni anno, sempre più studi confermano l'importanza delle api per l'equilibrio del nostro ambiente. Il loro declino non è solo un problema per l'agricoltura, ma per la biodiversità globale. Credo che dovremmo sensibilizzare di più la popolazione sulla gravità di questa situazione e fare di più per proteggerle, prima che sia troppo tardi.
                                    Ritengo che la gente non si renda conto di quanto sia grave la situazione. Le api sono vitali per la produzione del cibo che mangiamo, ma l'uso eccessivo di pesticidi e la perdita di habitat stanno mettendo a rischio la loro sopravvivenza. Dobbiamo educare i giovani a rispettare questi insetti e promuovere politiche più sostenibili.</p>
                            </div>
                        </div>
                    </div>
                    <div className="p-16 text-center flex flex-col items-center justify-center border-2 border-black rounded-md">
                        <p className="font-semibold text-primary text-6xl">Ecco come puoi aiutare!</p>
                        <p className="text-secondary text-3xl font-light pt-2 pb-10">Le api stanno soffrendo, abbiamo bisogno del tuo aiuto se vogliamo migliorare la loro situazione</p>




                        <Link className="shadow-[0px_0px_15px_16px_rgba(236,_72,_153,_0.15)] border-2 rounded-full border-black flex items-center justify-center p-3 " href="">
                            ...
                            </svg> <p className="text-primary text-3xl font-semibold px-10">Effettua una donazione</p>
                            <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="none" viewBox="0 0 24 24">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 9h5m3 0h2M7 12h2m3 0h5M5 5h14a1 1 0 0 1 1 1v9a1 1 0 0 1-1 1h-6.616a1 1 0 0 0-.67.257l-2.88 2.592A.5.5 0 0 1 8 18.477V17a1 1 0 0 0-1-1H5a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1Z" />
                            </svg>
                        </Link>
                ...
                <section className="w-full pb-28">
                    <div>
                        <p className="text-primary font-semibold text-4xl border-b-2"> Prossimi passi </p>
                    </div>
                    <div className="text-secondary text-xl font-light pt-4">
                        <p>Per affrontare il problema della scomparsa delle api e migliorare la loro conservazione, sono necessari interventi mirati. Ecco cosa andremo a migliorare: </p>
                        <div className="flex flex-col gap-2 pt-6">
                            <li>Incrementare l'educazione ambientale nelle scuole per sensibilizzare i giovani sulle api.</li>
                            <li>Promuovere politiche agricole sostenibili per proteggere gli habitat naturali.</li>
                            <li>Investire in ricerca scientifica per capire meglio le cause della perdita delle api.</li>
                            <li>Rafforzare le leggi di protezione per evitare l'uso eccessivo di pesticidi dannosi.</li>
                            <li>Sostenere iniziative di giardinaggio urbano che favoriscano la presenza di api in città.</li>
                        </div>
                    </div>
                </section>
